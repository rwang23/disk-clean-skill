...
[references/post-deploy-contract.md](references/post-deploy-contract.md)。
...
4. 读取 [references/metadata-contract.md](references/metadata-contract.md)，确认候选的状态、时间、owner 和保护字段。
